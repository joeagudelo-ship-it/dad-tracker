...
export const SECTION_THEMES: Record<string, { bg: string; text: string; gradient: string }> = {
  ...
  status: { bg: "bg-[#d1fae5] dark:bg-[#064e3b]", text: "text-[#059669]", gradient: "from-[#059669] to-[#10b981]" },
  meal: { bg: "bg-[#ffedd5] dark:bg-[#431407]", text: "text-[#ea580c]", gradient: "from-[#ea580c] to-[#f97316]" },
  event: { bg: "bg-[#f1f5f9] dark:bg-[#334155]", text: "text-[#475569]", gradient: "from-[#475569] to-[#64748b]" },
};
